        ...
        if ((promedio >= 7.5) && (promedio <= 10)) {
            ...
            if ((promedio >= 5) && (promedio < 7.5)) {
                ...
                if ((promedio >= 3) && (promedio < 5)) {
                    ...
                    // + "promedio: %.2f\n", promedio);
                    mensaje = String.format("Estudiante entra a recuperación"
                            + "con un promedio: %.2f\n", promedio);
                } else {
                    if ((promedio < 3) && (promedio >= 0)) {
                        ...
                        if (promedio < 0) {
                            // System.out.printf("La nota %.2f es de valor negativo ",
                            // promedio);
                            mensaje = String.format("La nota %.2f es de "
                                    + "valor negativo" + promedio);
                        } else {
                            //System.out.printf("La nota %.2f está fuera de rango ",
                            //   promedio);
                            mensaje = String.format("La nota %.2f está fuera de"
                                    + " rango" + promedio);
                        }
                    }
                }
